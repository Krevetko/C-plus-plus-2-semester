...
void GYM::extendMembership(int Month){
  this -> subscription += Month;
}
void GYM::cancelSubscription(){
  this -> subscription = 0;
}
void GYM::print(int nameLength) {
  cout << "Member " << this->id << ": ";
...
void GYM::set(int ID, string Name, int Month){
  this -> id = ID;
  this -> name = Name;
  this -> subscription = Month;
}
...
int main() {
  ...
  GYM subscribtion[4];
  subscribtion[0] = GYM(1, "John Doe", 6);
